...
◈ Instructions(for 1.3 v.)
- Enter target(URL)
- Enter power(threads) in natural numbers(recomended: 800-1200)
- Select option:
1) “Always use one User-Agent” - one user agent will be selected for you to be used continuously.
2) “Change User-Agent for each cycle” - the device identifier will be constantly changing during an attack.
